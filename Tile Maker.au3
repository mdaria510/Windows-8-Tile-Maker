...
Func GetGameInfoFromShortcut()
	...
	if $CmdLine[0] = "" Then
			MsgBox(0,"No Shortcut found.",' To use, place shortcut to this program into "Send To" folder. Then select any folder(s), right click and choose "Send To -> Tile Maker".')
			exit
	EndIf
	...
	If StringInStr($SteamURLPreTrim, "steam") Then
		...
		$SteamIconPath = StringTrimLeft($SteamIconPathPreTrim, 9)
